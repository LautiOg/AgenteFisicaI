...
## Resumen
Este proyecto detalla el desarrollo y la evaluación de un asistente de inteligencia artificial tutor dirigido a estudiantes universitarios de física y mecánica. Impulsado por el modelo de lenguaje de última generación Google Gemini 2.0 Flash, el sistema fue diseñado para responder consultas utilizando de forma exclusiva el material bibliográfico de la cátedra y textos de referencia de mecánica clásica mediante la técnica de recuperación de información (RAG). El agente permite responder de manera detallada consultas teóricas y problemas numéricos paso a paso, citar con precisión la fuente y página bibliográfica utilizada, alertar formalmente en caso de responder fuera del material del curso con búsquedas generales, generar automáticamente representaciones gráficas temporales de cinemática y diagramas vectoriales interactivos, e interpretar imágenes de ejercicios manuscritos o guías fotografiadas. El material de consulta indexado incluyó guías prácticas de trabajos prácticos, problemas de examen resueltos y libros de física clásica como Sears-Zemansky y Meriam. Durante la evaluación experimental realizada con cincuenta problemas reales del curso, el sistema demostró una mejora notable en la precisión conceptual (92% de acierto frente a 64% del modelo genérico) y consistencia académica, eliminando casi por completo las alucinaciones de fórmulas matemáticas y adaptándose rigurosamente a las convenciones de versores polares e intrínsecos enseñadas por los docentes.
